...
In 2015, an alternative method denoted CycleFreeFlux was suggested for removing type III cycles without the need of an MILP \cite{Desouki2015-lh}. Instead of adding extra variables and constraints to the original FBA framework, CycleFreeFlux performs a post-processing step \emph{after} the FBA problem is solved in the standard way. Since both steps are non-integer LPs, this method is 400-2500 times faster than ll-FBA.
